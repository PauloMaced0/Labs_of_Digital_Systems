...
-- Equation(s):
-- \inst|decout_n[6]~16_combout\ = (\inst|decout_n[6]~2_combout\) # (!\SW[4]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \inst|decout_n[6]~2_combout\,
	datac => \SW[4]~input_o\,
...
-- Equation(s):
-- \inst|decout_n~7_combout\ = ((\SW[3]~input_o\ & (\inst|decout_n~6_combout\ & \SW[0]~input_o\)) # (!\SW[3]~input_o\ & (\inst|decout_n~6_combout\ $ (\SW[0]~input_o\)))) # (!\SW[4]~input_o\)
...
-- Equation(s):
-- \inst|decout_n~9_combout\ = (\inst|decout_n~8_combout\) # (!\SW[4]~input_o\)
...
-- Equation(s):
-- \inst|decout_n[3]~17_combout\ = (\inst|decout_n[3]~5_combout\) # (!\SW[4]~input_o\)
...
-- pragma translate_on
PORT MAP (
	datab => \inst|decout_n[3]~5_combout\,
	datac => \SW[4]~input_o\,
...
-- Equation(s):
-- \inst|decout_n~11_combout\ = ((\SW[3]~input_o\ & (!\inst|decout_n~10_combout\ & \SW[2]~input_o\)) # (!\SW[3]~input_o\ & (\inst|decout_n~10_combout\ & !\SW[2]~input_o\))) # (!\SW[4]~input_o\)
...
-- Equation(s):
-- \inst|decout_n~13_combout\ = (\inst|decout_n~12_combout\) # (!\SW[4]~input_o\)
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|decout_n~12_combout\,
	datac => \SW[4]~input_o\,
...
-- Equation(s):
-- \inst|decout_n~15_combout\ = (\inst|decout_n~14_combout\) # (!\SW[4]~input_o\)
