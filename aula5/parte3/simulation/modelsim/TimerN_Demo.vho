...
SIGNAL \inst|timeOut~0_combout\ : std_logic;
...
SIGNAL \inst|timeOut~1_combout\ : std_logic;
SIGNAL \inst|timeOut~2_combout\ : std_logic;
SIGNAL \inst|timeOut~q\ : std_logic;
...
-- Equation(s):
-- \inst|Equal1~2_combout\ = (\inst|s_count\(5) & (\inst|s_count\(7) & (\inst|s_count\(4) & \inst|s_count\(6))))
...
-- Equation(s):
-- \inst|Equal1~1_combout\ = (\inst|s_count\(0) & (\inst|s_count\(3) & (\inst|s_count\(2) & \inst|s_count\(1))))
...
-- Equation(s):
-- \inst|Equal1~5_combout\ = (\inst|Equal1~4_combout\ & (\inst|Equal1~3_combout\ & (\inst|Equal1~2_combout\ & \inst|Equal1~1_combout\)))
...
\inst|timeOut~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|timeOut~0_combout\ = (!\inst|Equal0~10_combout\ & (((!\inst|Equal1~5_combout\) # (!\inst|Equal1~0_combout\)) # (!\inst|Equal0~3_combout\)))
...
PORT MAP (
	...
	combout => \inst|timeOut~0_combout\);

-- Location: LCCOMB_X41_Y62_N0
\inst|s_count[1]~50\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|s_count[1]~50_combout\ = (\SW[2]~input_o\) # ((!\inst|timeOut~0_combout\ & ((!\SW[0]~input_o\) # (!\inst|Equal0~10_combout\))))
...
-- Equation(s):
-- \inst|Equal0~0_combout\ = (!\inst|s_count\(9) & (!\inst|s_count\(8) & (!\inst|s_count\(10) & !\inst|s_count\(11))))
...
-- Equation(s):
-- \inst|Equal0~2_combout\ = (!\inst|s_count\(29) & (!\inst|s_count\(30) & (!\inst|s_count\(28) & !\inst|s_count\(27))))
...
-- Equation(s):
-- \inst|Equal0~4_combout\ = (!\inst|s_count\(23) & (!\inst|s_count\(26) & !\inst|s_count\(24)))
...
-- Equation(s):
-- \inst|Equal0~8_combout\ = (!\inst|s_count\(20) & (!\inst|s_count\(18) & (!\inst|s_count\(22) & !\inst|s_count\(21))))
...
-- Equation(s):
-- \inst|Equal0~6_combout\ = (!\inst|s_count\(6) & (!\inst|s_count\(5) & (!\inst|s_count\(7) & !\inst|s_count\(4))))
...
-- Equation(s):
-- \inst|Equal0~5_combout\ = (!\inst|s_count\(1) & (!\inst|s_count\(3) & (!\inst|s_count\(2) & !\inst|s_count\(0))))
...
-- Equation(s):
-- \inst|Equal0~9_combout\ = (\inst|Equal0~8_combout\ & (\inst|Equal0~6_combout\ & (\inst|Equal0~7_combout\ & \inst|Equal0~5_combout\)))
...
-- Equation(s):
-- \inst|Equal0~10_combout\ = (\inst|Equal0~3_combout\ & (\inst|Equal0~4_combout\ & \inst|Equal0~9_combout\))
...
\inst|timeOut~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|timeOut~1_combout\ = (\inst|timeOut~0_combout\) # ((\inst|Equal0~10_combout\ & \SW[0]~input_o\))
...
PORT MAP (
	...
	datab => \SW[0]~input_o\,
	datad => \inst|timeOut~0_combout\,
	combout => \inst|timeOut~1_combout\);

-- Location: LCCOMB_X42_Y62_N28
\inst|timeOut~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|timeOut~2_combout\ = (!\SW[2]~input_o\ & ((\SW[1]~input_o\ & ((\inst|timeOut~1_combout\))) # (!\SW[1]~input_o\ & (\inst|timeOut~q\))))
...
PORT MAP (
	dataa => \SW[2]~input_o\,
	datab => \SW[1]~input_o\,
	datac => \inst|timeOut~q\,
	datad => \inst|timeOut~1_combout\,
	combout => \inst|timeOut~2_combout\);

-- Location: FF_X42_Y62_N29
\inst|timeOut\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
